...
namespace TeacherAssisstantBE.Controllers
{
    ...
    public class SubjectsController : ControllerBase
    {
        ...
        // GET: api/Subjects/question
        [HttpGet("questions")]
        public async Task<ActionResult<IEnumerable<Subject>>> GetSubjectQuestion()
        {
            return await _context.Subject.Include(s => s.Questions).ThenInclude(q => q.Answers).ToListAsync();
        }
