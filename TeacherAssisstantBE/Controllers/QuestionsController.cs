...
namespace TeacherAssisstantBE.Controllers
{
    ...
    public class QuestionsController : ControllerBase
    {
        ...
        [HttpGet("Answer")]
        public async Task<ActionResult<IEnumerable<Question>>> GetQuestionAnswer()
        {
        ...
        {
            var question = await _context.Question.Where(q => q.QuestionId == id ).Include(q => q.Answers).FirstOrDefaultAsync();
